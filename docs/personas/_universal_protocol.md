...
6. Resolve each item from steps 4-5 from the code, docs, and prior artifacts. Do not guess and do not invent answers.
7. Restate the scope, deliverables, and constraints at the top of your final report.
...
7. **Don't skip probing questions to "move fast."** Surface them as "Open questions for the orchestrator" — 5 good questions now save 5 days of rework later.
