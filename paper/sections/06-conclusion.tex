...
\begin{enumerate}
    \item \textbf{Performance}: UWS achieves context recovery in 42ms on average, compared to 5--10 minutes for baselines---a $>$99.9\% improvement with extremely large effect sizes ($d > 48$).
