...
\begin{enumerate}
    \item \textbf{Performance}: UWS achieves context recovery in 42ms on average, compared to 5--10 minutes for baselines---an order-of-magnitude improvement enabled by structured state persistence.

    \item \textbf{Reliability}: Checkpoint recovery succeeds in 100\% of cases under failure injection, exceeding our 95\% target.
