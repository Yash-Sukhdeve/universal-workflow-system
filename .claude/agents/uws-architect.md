...
<!-- model: opus. To change it, re-run scripts/gen_subagents.sh with UWS_AGENT_MODEL_ARCHITECT=<opus|sonnet|haiku|fable|inherit>, or UWS_AGENT_MODEL=inherit to use the session model for all roles. -->
